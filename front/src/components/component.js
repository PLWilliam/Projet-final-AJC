...
export { default as ProductCard } from './productsPages/ProductCard';
export { default as ButtonAddDel } from './productsPages/ButtonAddDel';
...
export { default as FeaturedProducts } from './productsPages/FeaturedProducts';